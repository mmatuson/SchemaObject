...
class TestColumnSchema(unittest.TestCase):
    ...
    def test_read_column_not_null(self):
    ...
    def test_read_column_comment(self):
    ...
    def test_define_extra_column(self):
    ...
    def test_define_column_comment(self):
    ...
    def test_column_charset_collate_diff_from_parent(self):
        ...
        self.assertEqual(
            "`first_name` varchar(45) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL AFTER `store_id`",
            self.db.tables['customer'].columns['first_name'].define(after='store_id'))
    ...
    def test_column_definition_syntax(self):
        ...
        self.assertEqual(
            "`first_name` varchar(45) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL DEFAULT 'bob' COMMENT 'first name' AFTER `store_id`",
